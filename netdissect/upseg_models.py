...
import torchvision
import upseg_resnet, upseg_resnext
try:
...
class ModelBuilder:
    ...
    def build_encoder(self, arch='resnet50_dilated8', fc_dim=512, weights=''):
        ...
        if arch == 'resnet50':
            orig_resnet = upseg_resnet.__dict__['resnet50'](pretrained=pretrained)
            net_encoder = Resnet(orig_resnet)
        elif arch == 'resnet101':
            orig_resnet = upseg_resnet.__dict__['resnet101'](pretrained=pretrained)
            net_encoder = Resnet(orig_resnet)
        elif arch == 'resnext101':
            orig_resnext = upseg_resnext.__dict__['resnext101'](pretrained=pretrained)
